...
@php
    $dynamicClass = $active ? '' : 'hidden';
@endphp


<a {{ $attributes }}
    class="relative inline-flex items-center px-2 py-1 cursor-pointer
        ...
        duration-150 dark:bg-gray-800 dark:border-gray-600 dark:active:bg-gray-700 dark:focus:border-blue-800
        {{ $active ? '' : 'hidden' }}">{{ $slot }}
</a>
{{-- <a
    {{ $attributes->merge([
