    ...
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-8 w-8 rounded-md"
                                src="https://i.pinimg.com/564x/bd/a1/b4/bda1b4b9bd90054c9a44ce21adbb89ac.jpg"
                                alt="Your Company">
                        </div>
                    ...
                    <div class="flex items-center px-5">
                        <div class="flex-shrink-0">
                            <img class="h-10 w-10 rounded-full"
                                src="https://i.pinimg.com/564x/20/d4/ee/20d4eee4353ecea79e43d4f2c17e488c.jpg"
                                alt="">
                        </div>
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">Smi</div>
                            <div class="text-sm font-medium leading-none text-gray-400">Smi@email.com</div>
                        </div>
                        <button type="button"
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
                ...
                <x-button href='/jobs/create' :active="request()->is('jobs')">Create Info</x-button>
            </div>
        </header>
        <main>
